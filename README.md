...
[![Purple Preview](https://joealongi.github.io/bootstrap-purple/img/purple_-_multi-page_bootstrap_product_template.jpg)](https://joealongi.github.iobootstrap-purple/)
...
- **Option 1.)** [Download the latest version of this template from GitHub](https://github.com/joealongi/bootstrap-purple/archive/master.zip)
- **Option 2.)** Clone this repository

```
                  git clone https://github.com/joealongi/bootstrap-purple.git
```

- **Option 3.)** [Fork, Clone, or Download via GitHub Desktop](x-github-client://openRepo/https://github.com/joealongi/bootstrap-purple/)
...
Having an issue with the template? Report bugs & issues with Purple on GitHub via [Issues](https://github.com/joealongi/bootstrap-purple/issues).
...
© 2022 Joe Alongi released via [MIT](https://opensource.org/licenses/MIT) license. Information on this license can be viewed as it applies to this repository on GitHub at [Purple License](https://github.com/joealongi/bootstrap-purple/blob/master/LICENSE).
